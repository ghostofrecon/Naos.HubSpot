...
namespace Naos.HubSpot.Domain.Contracts.ContactsApi.QueryModels
{
    ...
    /// <summary>
    /// Class represents the query params used to get the recently modified contacts.
    /// </summary>
    public class GetRecentlyModifiedContactsQuery
    {
        /// <summary>
        ...
        public PropertyMode PropertyMode { get; private set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRecentlyModifiedContactsQuery"/> class.
        /// </summary>
        ...
        public GetRecentlyModifiedContactsQuery(
            string timeOffset,
            int count = 20,
            int vidOffset = 0,
