...
{
    /// <summary>
    /// The class that represents the body of the update contact by email request.
    /// </summary>
    public class UpdateContactByEmailPayload
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateContactByEmailPayload"/> class.
        ...
        public UpdateContactByEmailPayload(string email, string firstName, string lastName, string website, string lifeCycleStage)
        {
            this.Email = email;
